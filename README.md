...
```
Sostituire PATH_TO_BE_CONFIGURED con il path nel proprio computer. Occorre modificare anche i path dei modelli all'interno del file **model_server.config**.
