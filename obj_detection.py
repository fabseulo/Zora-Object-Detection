...
def find_result(image_path, image_name):
    ...
    channel = implementations.insecure_channel('0.0.0.0', 9000)  # crea un canale non sicuro con l'host, numero di porta 9000
    ...
    if (scores[0] >= 0.6):
        ...
        counter = counter.items()  # converte il dizionario in una lista di coppie con nome della label e occorrenza
